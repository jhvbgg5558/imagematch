#!/usr/bin/env python3
"""Batch-run local geometry reranking on an existing validation round."""
...
def main() -> None:
    ...
    script_path = Path(__file__).resolve().parent / "rerank_with_local_geometry.py"
    ...
    lines = ["# Geometry Rerank Validation Summary", ""]
