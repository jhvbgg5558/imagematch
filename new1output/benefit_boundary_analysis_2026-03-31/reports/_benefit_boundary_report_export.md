...
![figure_1_bucket_counts.png](../figures/figure_1_bucket_counts.png){ width=85% }

![figure_2_bucket_by_flight.png](../figures/figure_2_bucket_by_flight.png){ width=85% }

![figure_3_rank_scatter.png](../figures/figure_3_rank_scatter.png){ width=85% }

![figure_4_top1_error_delta_boxplot.png](../figures/figure_4_top1_error_delta_boxplot.png){ width=85% }

![figure_5_pitch_distribution.png](../figures/figure_5_pitch_distribution.png){ width=85% }

![figure_6_truthcount_footprint_distribution.png](../figures/figure_6_truthcount_footprint_distribution.png){ width=85% }

![figure_7_b_rank_gain_distribution.png](../figures/figure_7_b_rank_gain_distribution.png){ width=85% }
...
| 主桶 | query 数 | 新增 Top-1 命中 | 新增命中占比 | 解释 |
| --- | --- | --- | --- | --- |
| A | 31 | 0 | 0.0% | Already correct at Top-1; limited direct contribution to R@1 gain. |
| B | 6 | 6 | 100.0% | Main source of new Top-1 hits after reranking. |
| C | 3 | 0 | 0.0% | Coarse recall exists but rerank does not finish correction. |
| D | 0 | 0 | 0.0% | Upper bound is constrained by coarse recall. |

### B 类 6 个收益案例

#### q_002

![q_002 top10](../../query_reselect_2026-03-26_v2/romav2_eval_2026-03-30_gpu/figures/DJI_202510311347_009_新建面状航线1/q_002_top10.png){ width=90% }

- query_id: `q_002`
- flight_id: `DJI_202510311347_009_新建面状航线1`
- coarse_first_truth_rank: `3`
- romav2_first_truth_rank: `1`
- rank_gain: `2`
- delta_top1_error_m: `-2379.561`

#### q_003

![q_003 top10](../../query_reselect_2026-03-26_v2/romav2_eval_2026-03-30_gpu/figures/DJI_202510311347_009_新建面状航线1/q_003_top10.png){ width=90% }

- query_id: `q_003`
- flight_id: `DJI_202510311347_009_新建面状航线1`
- coarse_first_truth_rank: `2`
- romav2_first_truth_rank: `1`
- rank_gain: `1`
- delta_top1_error_m: `-1292.689`

#### q_013

![q_013 top10](../../query_reselect_2026-03-26_v2/romav2_eval_2026-03-30_gpu/figures/DJI_202510311413_010_新建面状航线1/q_013_top10.png){ width=90% }

- query_id: `q_013`
- flight_id: `DJI_202510311413_010_新建面状航线1`
- coarse_first_truth_rank: `2`
- romav2_first_truth_rank: `1`
- rank_gain: `1`
- delta_top1_error_m: `-1367.575`

#### q_022

![q_022 top10](../../query_reselect_2026-03-26_v2/romav2_eval_2026-03-30_gpu/figures/DJI_202510311435_011_新建面状航线1/q_022_top10.png){ width=90% }
...
- romav2_first_truth_rank: `1`
- rank_gain: `2`
- delta_top1_error_m: `-860.563`

#### q_029

![q_029 top10](../../query_reselect_2026-03-26_v2/romav2_eval_2026-03-30_gpu/figures/DJI_202510311435_011_新建面状航线1/q_029_top10.png){ width=90% }
...
- romav2_first_truth_rank: `1`
- rank_gain: `1`
- delta_top1_error_m: `-1284.234`

#### q_037

![q_037 top10](../../query_reselect_2026-03-26_v2/romav2_eval_2026-03-30_gpu/figures/DJI_202510311500_012_新建面状航线1/q_037_top10.png){ width=90% }
...
### 按 pitch_group 的 B/C/D 比例

| pitch_group | query 数 | B 数量 | B 占比 | C 数量 | C 占比 | D 数量 | D 占比 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| downview | 20 | 3 | 15.0% | 2 | 10.0% | 0 | 0.0% |
| tilted | 20 | 3 | 15.0% | 1 | 5.0% | 0 | 0.0% |
