...
`query v2 + intersection truth` boundary.
...
2. Run the launcher in `scripts/run_romav2_dinov2_intersection_bundle.py`.
...
- `viz_top20_match_points/` for recomputed inlier visualizations only
