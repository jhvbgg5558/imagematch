#!/usr/bin/env python3
"""Rerank coarse retrieval candidates with SuperPoint + LightGlue under intersection-truth evaluation."""
...
def main() -> None:
    ...
    summary = {
        ...
        "intersection_hit_count@50": hit_counts[50],
        "per_query": per_query,
        "config": {
