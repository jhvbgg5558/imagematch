#!/usr/bin/env python3
"""Run the isolated new3output ODM-refresh plus satellite-truth experiment.
...
- `reports/odm_truth_vs_satellite_truth_comparison.md` and `.docx`.
    ...
    write_json(
        experiment_root / "plan" / "experiment_contract.json",
        {
            ...
            "main_variable_changes": [
                ...
                "parallel satellite truth validation suite added",
            ],
