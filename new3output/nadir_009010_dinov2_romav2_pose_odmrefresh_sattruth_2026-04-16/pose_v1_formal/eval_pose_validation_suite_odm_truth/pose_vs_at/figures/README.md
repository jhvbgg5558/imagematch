...
- `horizontal_error_m`: mean=6.6689 m, median=4.5570 m, p90=13.8576 m。
- `view_dir_angle_error_deg`: mean=0.8336 deg, median=0.5720 deg, p90=1.5756 deg。
- `reference_source_type_counts={'odm_report_shots_geojson': 40}`。
- 当前动态高亮 query 为 `q_035`：`horizontal_error_m=32.4217 m`，`view_dir_angle_error_deg=4.9897 deg`。
...
输出目录：`/mnt/d/aiproject/imagematch/new3output/nadir_009010_dinov2_romav2_pose_odmrefresh_sattruth_2026-04-16/pose_v1_formal/eval_pose_validation_suite_odm_truth/pose_vs_at/figures`
